...
# TF1.4
g++ -std=c++11 tf_interpolate.cpp -o tf_interpolate_so.so -shared -fPIC -I $TENSORFLOW_DIR/include -I $CUDA_PATH/include -I $TENSORFLOW_DIR/include/external/nsync/public -lcudart -L $CUDA_PATH/lib64/ -L$TENSORFLOW_DIR/ -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=1
